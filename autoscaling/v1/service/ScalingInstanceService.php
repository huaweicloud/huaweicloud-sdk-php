...
class ScalingInstanceService {
    ...
    public function getInstanceList(array $req, ASV1Client $asClient)
    {
        ...
        $authAkSkRequest->setUri('/autoscaling-api/v1/'.$asClient->getConfig()['project_id'].'/scaling_group_instance/'. $req['scaling_group_id']. '/list');
    ...
    public function actionInstance(array $req, ASV1Client $asClient)
    {
        $authAkSkRequest = new AuthAkSkRequest();
        ...
        $authAkSkRequest->setUri('/autoscaling-api/v1/'.$asClient->getConfig()['project_id'].'/scaling_group_instance/'. $req['scaling_group_id']. '/action');
        $authAkSkRequest->setHost($asClient->getConfig()['endpoint']);
